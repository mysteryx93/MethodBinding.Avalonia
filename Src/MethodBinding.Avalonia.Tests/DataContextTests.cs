...
namespace MethodBinding.Avalonia.Tests
{
    ...
    public class DataContextTests : TracedTests
    {
        ...
        public void NullDataContext()
        {
            ...
            TraceMessages[0].ShouldContain("Warning: 0 : [MethodBindingExtension] Null data context for method 'SomeMethod' on element 'TestElement' (type: 'Avalonia.StyledElement').");
        }
        ...
        public void MissingMethod()
        {
            ...
            TraceMessages.Count.ShouldBe(2);
            TraceMessages[0].ShouldEndWith("Warning: 0 : [MethodBindingExtension] Could not find parameterless method 'NonExistent' (target type 'MethodBinding.Avalonia.Tests.ViewModel').");
            TraceMessages[1].ShouldEndWith("Warning: 0 : [MethodBindingExtension] Could not find method 'NonExistent' (target type 'MethodBinding.Avalonia.Tests.ViewModel') that accepts the provided arguments (null).");
        }
        ...
        public void IntParameterAsInvalidXamlString()
        {
            ...
            vm.Executed.ShouldBe(false);
            TraceMessages.Count.ShouldBe(1);
            TraceMessages[0].ShouldContain("Warning: 0 : [MethodBindingExtension] Method 'IntParam' (target type 'MethodBinding.Avalonia.Tests.ViewModel') parameter 1 (name: 'x', type: 'System.Int32') could not be assigned from XAML string argument '5x':");
        }
        ...
        public void IntParameterAsNull()
        {
            ...
            vm.Executed.ShouldBe(false);
            TraceMessages.Count.ShouldBe(1);
            TraceMessages[0].ShouldEndWith("Warning: 0 : [MethodBindingExtension] Method 'IntParam' (target type 'MethodBinding.Avalonia.Tests.ViewModel') parameter 1 (name: 'x', type: 'System.Int32') is not assignable to null.");
        }
        ...
        //         "testhost Warning: 0 : [MethodBindingExtension] Method 'IntParam' (target type 'MethodBinding.Avalonia.Tests.ViewModel') parameter 1 (name: 'x', type: 'System.Int32') is not assignable to null.",
        //     });
        // }
        ...
        public void OverloadedNullableIntDoubleAsString()
        {
            ...
            vm.Executed.ShouldBe(false);
            TraceMessages.Count.ShouldBe(1);
            TraceMessages[0].ShouldEndWith("Warning: 0 : [MethodBindingExtension] Could not find method 'OverloadedNullableIntDouble' (target type 'MethodBinding.Avalonia.Tests.ViewModel') that accepts the provided arguments ('System.String').");
        }
    }
}